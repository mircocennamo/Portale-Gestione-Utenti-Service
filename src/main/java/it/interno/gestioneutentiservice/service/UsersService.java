...
public interface UsersService {
    ...
    Page<UsersDto> getUtentiAbilitati(FiltroUsersDto filtro, String ufficioRichiedente, String ruoloUtenteRichiedente);
    ...
    List<UsersDto> getUsersByAutocompleteCodiceCognomeEFP(String parametro, Integer codiceForzaPolizia);
