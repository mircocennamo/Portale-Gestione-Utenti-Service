...
public class UsersController {
    ...
    public ResponseEntity<ResponseDto<Page<UsersDto>>> getUtentiAbilitati(@RequestBody FiltroUsersDto filtro,
                                                                          @RequestParam String ufficioRichiedente,
                                                                          @RequestParam String ruoloUtenteRichiedente){
        return ResponseEntity.ok(ResponseDto.<Page<UsersDto>>builder()
                .code(HttpStatus.OK.value())
                .body(usersService.getUtentiAbilitati(filtro, ufficioRichiedente, ruoloUtenteRichiedente))
                .build()
        );
    }
    ...
    public ResponseEntity<ResponseDto<Integer>> getNumeroUtentiAbilitati(){

        return ResponseEntity.ok(ResponseDto.<Integer>builder()
                .code(HttpStatus.OK.value())
                .body(usersService.getNumeroUtentiAbilitati())
                .build()
        );
    }
    ...
    public ResponseEntity<ResponseDto<List<UsersDto>>> getUsersByAutocompleteCodiceCognomeEFP(@RequestParam String parametro,
        ...
        return ResponseEntity.ok(ResponseDto.<List<UsersDto>>builder()
                .code(HttpStatus.OK.value())
                .body(usersService.getUsersByAutocompleteCodiceCognomeEFP(parametro, codiceForzaPolizia))
                .build()
        );
    }
    ...
    public ResponseEntity<ResponseDto<Boolean>> getUsersByAutocompleteCodiceCognomeEFP(@RequestParam String codiceUfficio){
